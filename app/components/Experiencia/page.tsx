    ...
    return (
        ...
        <>
            <div className="w-full h-screen flex flex-col items-center justify-center gap-6 text-center text-white">
                <h1 className="text-6xl font-bold">Minha Experiência Profissional</h1>
                <p className="tracking-wide">Jornada profissional em desenvolvimento web e soluções inovadoras</p>
            </div>
            ...
            <div className="w-full flex justify-start md:justify-center px-6 sm:px-8 md:px-8 xl:px-0">
                ...
                <div className="w-full max-w-6xl flex flex-col md:flex-row gap-10 md:gap-10 text-white">
                    ...
                    <div className="flex flex-col gap-3 w-full md:w-70 text-left">
                        ...
                        <p className="text-2xl md:text-2xl font-semibold leading-tight">
                            Desenvolvedor Front-End<br />
                        </p>

                        <p className="text-[#575D69] text-xl md:text-2xl font-medium">
                            Yaslip
                        </p>
                    </div>

                    <div className="flex flex-col gap-4 text-[#9CA3AF] text-base md:text-[15px] max-w-3xl text-left mb-10">
